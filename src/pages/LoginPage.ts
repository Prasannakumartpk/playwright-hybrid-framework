...
export class LoginPage {
    ...
    /**
   * Dynamic Add Link for any date
   */
    addLinkForDate(date: string): Locator {
        return this.page.locator(`a.add_link[onclick*="${date}"]`);
    }

    /**
     * Click Add Link for today
     */
    async clickAddLinkForToday() {
